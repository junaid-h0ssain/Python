...
def main():
    ...
    # The key is the filename without extension, value is the full path.
    ...
    try:
        for filename in os.listdir(NON_ENCODED_FOLDER):
            ...
            if os.path.isfile(full_path):
                ...
                non_encoded_map[basename] = full_path
    ...
    try:
        for av1_entry in os.scandir(AV1_FOLDER):
            ...
            av1_basename, _ = os.path.splitext(av1_entry.name)

            # Check if a corresponding file exists in the non-encoded map
            if av1_basename.lower() in non_encoded_map:
                non_encoded_path = non_encoded_map[av1_basename.lower()]
