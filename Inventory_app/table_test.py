...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.scroll_area.setWidget(self.hello_label)
    ...
    def submit(self):
        ...
        if name and price and amount:
            self.hello_label.setStyleSheet('font-size:25px;')
            self.hello_label.setText(add_items.add(self.textbox.text(),
            ...
            self.hello_label.setStyleSheet('font-size:25px;')
            self.hello_label.setText(f'Name, price or amount was empty.')
